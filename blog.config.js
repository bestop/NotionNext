...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HiKid', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '启蒙教育🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.hikid.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '启蒙, 资源', // 网站关键词 英文逗号隔开
